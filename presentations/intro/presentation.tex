...
\begin{array}{ll}
  ...
  \\
  \multirow{2}{*}{\textcolor{BrickRed}{10K}} & \texttt{so we beat on , bo\textcolor{Fuchsia}{@@} ats against the cur\textcolor{Fuchsia}{@@} r\textcolor{Fuchsia}{@@} ent ,} \\
  {} & \texttt{bor\textcolor{Fuchsia}{@@} ne back ceaselessly into the past . } \\
  \\
  \multirow{2}{*}{\textcolor{BrickRed}{Full}} & \texttt{so we beat on , boats against the current , }\\
