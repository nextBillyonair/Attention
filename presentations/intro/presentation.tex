...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width=0.45\textwidth, valign=c]{assets/table_rotated}
    \pause
    $\longrightarrow$
    \includegraphics[width=0.45\textwidth, valign=c]{assets/mask3}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \pause
    $\longrightarrow$
    \includegraphics[width=0.45\textwidth, valign=c]{assets/tesseract}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \pause
    $\longrightarrow$
    \includegraphics[width=0.45\textwidth, valign=c]{assets/result1}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Vocabulary and Word Embeddings
