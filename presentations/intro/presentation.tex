...
\section{Seq2Seq in Action: Advanced Techniques\\(Part 2)}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \end{itemize}
    \item Part 2 wil explore more advanced concepts such as:
    \begin{itemize}
...
\begin{frame}
  \frametitle{Secondary Approach: Training Labels}
  \begin{itemize}
...
\begin{frame}
  \frametitle{Secondary Approach: Sample Results}
  \begin{figure}
    \centering
...
\begin{frame}
  \frametitle{Joint Table Training: Sample Results}
  \begin{figure}
    \centering
    \includegraphics[height=3.75cm, valign=c]{assets/cm_table}
    \includegraphics[height=3.75cm, valign=c]{assets/cm_table_norm}
  \end{figure}
  \begin{center}
    \begin{tabular}{rcccr}
    \toprule
    {} &  Precision &  Recall &  F1-Score & Support \\
    \midrule
    Label: 0 & $1.00$ & $0.96$ & $0.98$ & $168,275$ \\
    Label: 1 & $0.83$ & $0.98$ & $0.90$ & $28,685$ \\
    \midrule
    accuracy & {} & {} & $0.97$ & $196,960$ \\
    macro avg & $0.91$ & $0.97$ & $0.94$ & $196,960$ \\
    weighted avg & $0.97$ & $0.97$ & $0.97$ & $196,960$ \\
    \bottomrule
    \end{tabular}
  \end{center}
  % something
...
\begin{frame}
  \frametitle{Joint Table Training with Swapping: Sample Results}
  \begin{figure}
    \centering
    \includegraphics[height=3.75cm, valign=c]{assets/cm_table_swap}
    \includegraphics[height=3.75cm, valign=c]{assets/cm_table_swap_norm}
  \end{figure}
  \begin{center}
    \begin{tabular}{rcccr}
    \toprule
    {} &  Precision &  Recall &  F1-Score & Support \\
    \midrule
    Label: 0 & $1.00$ & $0.97$ & $0.98$ & $168,275$ \\
    Label: 1 & $0.83$ & $0.98$ & $0.90$ & $28,685$ \\
    \midrule
    accuracy & {} & {} & $0.97$ & $196,960$ \\
    macro avg & $0.92$ & $0.97$ & $0.94$ & $196,960$ \\
    weighted avg & $0.97$ & $0.97$ & $0.97$ & $196,960$ \\
    \bottomrule
    \end{tabular}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \midrule
    \multirow{3}{*}{Label: 0} & Precision & $0.99$ & $\mathbf{1.00}$ & $\mathbf{1.00}$ \\
    {}                        & Recall    & $0.92$ & $0.96$ & $\mathbf{0.97}$ \\
    {}                        & F1-Score  & $0.96$ & $\mathbf{0.98}$ & $\mathbf{0.98}$ \\
    \midrule
    \multirow{3}{*}{Label: 1} & Precision & $0.67$ & $\mathbf{0.83}$ & $\mathbf{0.83}$ \\
    {}                        & Recall    & $0.97$ & $\mathbf{0.98}$ & $\mathbf{0.98}$ \\
    {}                        & F1-Score  & $0.80$ & $\mathbf{0.90}$ & $\mathbf{0.90}$ \\
    \midrule
    {}                        & Accuracy  & $0.93$ & $\mathbf{0.97}$ & $\mathbf{0.97}$ \\
    \bottomrule
    \end{tabular}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item No significant difference between regular and swapped hidden state propagation
    \item \textbf{Note:}
    \begin{itemize}
